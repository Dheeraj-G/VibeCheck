...
// /:https://framerusercontent.com/modules/wMLDbah0AqHl6M134YSD/OU3VNINXxuTcQ6qwv5XA/godgLM0uU.js
import { jsx as _jsx5, jsxs as _jsxs4 } from "react/jsx-runtime";
import { addFonts, ComponentViewportProvider, cx as cx2, getFonts, RichText, SmartComponentScopedContainer, useComponentViewport, useLocaleInfo as useLocaleInfo3, useVariantState, withCSS as withCSS3 } from "unframer";
import { LayoutGroup, motion as motion5, MotionConfigContext } from "unframer";
import * as React3 from "react";
import { useRef as useRef4 } from "react";

// /:https://framerusercontent.com/modules/6wAE2eMb2Tl3zrU7u4UL/fZYCcWXDiruXib2k8aXr/Search.js
...
// /:https://framerusercontent.com/modules/tV9haTHllpHHc9Fjue2H/JehrJSLhXvzeRdsqPjt4/SearchModal.js
import { jsx as _jsx2, jsxs as _jsxs2 } from "react/jsx-runtime";

// /:https://framerusercontent.com/modules/MyBp84Z0p9nUcMimVMnY/5ZXslHiv3E1xnzOoHbJF/useSearch.js
...
async function getCachedIndex(localeId, indexHash) {
  ...
  if (cachedIndex) {
    return { status: indexHash && (metadata === null || metadata === void 0 ? void 0 : metadata.indexHash) === indexHash ? "fresh" : "stale", searchIndex: cachedIndex };
  }
  return { status: "miss" };
}
...
// /:https://framerusercontent.com/modules/MWsEnYfRnoOQq31DN4ql/fxR5MNtgeSOU8Mj4iY9n/utils.js
...
async function executeRawSearch(index, query, settings, signal) {
  ...
  for (let i = 0; i < items.length; ++i) {
    ...
    if (score > (settings.minimumScore || 0) && (!path || item.url !== path)) {
      ...
      const title = settings?.titleType === SearchResultTitleType.Title ? item.title : heading ? heading : item.title;
...
function useSearch(query, settings) {
  ...
  useEffect(() => {
    async function loadSearchIndex() {
      setStatus("loading");
      const metaTag = safeDocument?.querySelector('meta[name="framer-search-index"]');
      if (!metaTag) {
...
// /:https://framerusercontent.com/modules/tV9haTHllpHHc9Fjue2H/JehrJSLhXvzeRdsqPjt4/SearchModal.js
import React, { useEffect as useEffect2, useState as useState2, useMemo, forwardRef, useRef as useRef2, useDeferredValue, useLayoutEffect, useCallback as useCallback2, useImperativeHandle } from "react";
...
var Input = /* @__PURE__ */ forwardRef(function Input2(props, ref) {
  ...
  const searchIcon = iconType === "custom" && theme.inputIconImage ? /* @__PURE__ */ _jsx2("img", { alt: "icon alongside the Site Search input", src: theme.inputIconImage.src, width: theme.inputIconSize, height: theme.inputIconSize, decoding: "async" }) : /* @__PURE__ */ _jsx2(SearchIcon, { color: theme.inputIconColor, width: theme.inputIconSize, height: theme.inputIconSize });
...
// /:https://framerusercontent.com/modules/Mr5K6fTnlrfaIU1TWdB8/j2VSTw8qaQBFvzPkpWDc/ojirr6bsR.js
import { jsx as _jsx4 } from "react/jsx-runtime";
import { addPropertyControls as addPropertyControls2, ControlType as ControlType2, cx, motion as motion4, withCSS as withCSS2 } from "unframer";
import * as React2 from "react";
import { forwardRef as forwardRef4 } from "react";
var mask = `url('data:image/svg+xml,<svg display="block" role="presentation" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path d="M 0 8 C 0 3.582 3.582 0 8 0 C 12.418 0 16 3.582 16 8 C 16 12.418 12.418 16 8 16 C 3.582 16 0 12.418 0 8 Z" fill="transparent" height="16px" id="xlwuWNpoE" stroke-dasharray="" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" stroke="var(--43q7um, rgb(0,0,0))" transform="translate(3 3)" width="16px"/><path d="M 4.35 4.35 L 0 0" fill="transparent" height="4.350000000000001px" id="Mu_JjZHRF" stroke-dasharray="" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" stroke="var(--43q7um, rgb(0,0,0))" transform="translate(16.65 16.65)" width="4.350000000000001px"/></svg>') alpha no-repeat center / auto var(--framer-icon-mask-mode, add), var(--framer-icon-mask, none)`;
...
var Component = /* @__PURE__ */ React2.forwardRef(function(props, ref) {
  ...
  return /* @__PURE__ */ _jsx4(SVG, { ...restProps, className: cx("framer-PtNER", className), layoutId, ref, style: { "--43q7um": UO5clYVeQ, ...style } });
});
var css = [`.framer-PtNER { -webkit-mask: ${mask}; aspect-ratio: 1; background-color: var(--43q7um); mask: ${mask}; width: 24px; }`];
var Icon = withCSS2(Component, css, "framer-PtNER");
...
var Search1Fonts = getFonts(stdin_default2);
var serializationHash = "framer-B5kiH";
var variantClassNames = { eIMKhWPnb: "framer-v-mw7eqk" };
...
var Component2 = /* @__PURE__ */ React3.forwardRef(function(props, ref) {
  ...
  const { baseVariant, classNames, clearLoadingGesture, gestureHandlers, gestureVariant, isLoading, setGestureState, setVariant, variants } = useVariantState({ defaultVariant: "eIMKhWPnb", ref: refBinding, variant, variantClassNames });
  const layoutDependency = createLayoutDependency(props, variants);
  const sharedStyleClassNames = [];
  const scopingClassNames = cx2(serializationHash, ...sharedStyleClassNames);
  return /* @__PURE__ */ _jsx5(LayoutGroup, { id: layoutId ?? defaultLayoutId, children: /* @__PURE__ */ _jsx5(Variants, { animate: variants, initial: false, children: /* @__PURE__ */ _jsx5(Transition, { value: transition1, children: /* @__PURE__ */ _jsxs4(motion5.div, { ...restProps, ...gestureHandlers, className: cx2(scopingClassNames, "framer-mw7eqk", className, classNames), "data-framer-name": "Variant 1", layoutDependency, layoutId: "eIMKhWPnb", ref: refBinding, style: { backgroundColor: "rgb(43, 43, 43)", borderBottomLeftRadius: 99, borderBottomRightRadius: 99, borderTopLeftRadius: 99, borderTopRightRadius: 99, ...style }, children: [/* @__PURE__ */ _jsx5(RichText, { __fromCanvasComponent: true, children: /* @__PURE__ */ _jsx5(React3.Fragment, { children: /* @__PURE__ */ _jsx5(motion5.p, { style: { "--framer-text-color": "var(--extracted-r6o4lv, rgb(110, 110, 110))" }, children: "Search your songs\u2026" }) }), className: "framer-1elania", fonts: ["Inter"], layoutDependency, layoutId: "nfDYmZWFt", style: { "--extracted-r6o4lv": "rgb(110, 110, 110)", "--framer-link-text-color": "rgb(0, 153, 255)", "--framer-link-text-decoration": "underline" }, verticalAlignment: "top", withExternalLayout: true }), /* @__PURE__ */ _jsx5(ComponentViewportProvider, { children: /* @__PURE__ */ _jsx5(SmartComponentScopedContainer, { className: "framer-1jajksr-container", isAuthoredByUser: true, isModuleExternal: true, layoutDependency, layoutId: "BtjjJ_NbU-container", nodeId: "BtjjJ_NbU", rendersWithMotion: true, scopeId: "godgLM0uU", children: /* @__PURE__ */ _jsx5(stdin_default, { backdropOptions: { backgroundColor: "rgba(0, 0, 0, 0.8)", transition: { damping: 60, delay: 0, mass: 1, stiffness: 500, type: "spring" }, zIndex: 10 }, height: "100%", iconColor: "rgb(51, 51, 51)", iconSize: 0, iconType: "default", id: "BtjjJ_NbU", inputOptions: { clearButtonText: "Clear", clearButtonType: "icon", dividerType: "fullWidth", iconOptions: { iconColor: "rgba(0, 0, 0, 0.45)", iconSize: 18, iconType: "default" }, inputFont: {}, placeholderOptions: { placeholderColor: "rgba(0, 0, 0, 0.4)", placeholderText: "Search..." }, textColor: "rgb(51, 51, 51)" }, layoutId: "BtjjJ_NbU", modalOptions: { backgroundColor: "rgb(255, 255, 255)", borderRadius: 16, heightIsStatic: true, heightTransition: { damping: 60, delay: 0, mass: 1, stiffness: 800, type: "spring" }, layoutType: "QuickMenu", shadow: { blur: 40, color: "rgba(0, 0, 0, 0.2)", spread: 0, x: 0, y: 20 }, top: 0, width: 500 }, resultOptions: { itemType: "fullWidth", subtitleOptions: { subtitleColor: "rgba(0, 0, 0, 0.4)", subtitleFont: {}, subtitleType: "path" }, titleColor: "rgb(51, 51, 51)", titleFont: {}, titleType: "h1" }, style: { height: "100%", width: "100%" }, width: "100%" }) }) }), /* @__PURE__ */ _jsx5(stdin_default2, { animated: true, className: "framer-acwhom", layoutDependency, layoutId: "I5xDBusgM", style: { "--43q7um": "rgb(110, 110, 110)" } })] }) }) }) });
});
var css2 = ["@supports (aspect-ratio: 1) { body { --framer-aspect-ratio-supported: auto; } }", ".framer-B5kiH.framer-3fq25g, .framer-B5kiH .framer-3fq25g { display: block; }", ".framer-B5kiH.framer-mw7eqk { align-content: center; align-items: center; display: flex; flex-direction: row; flex-wrap: nowrap; height: 50px; justify-content: space-between; overflow: hidden; padding: 0px 20px 0px 20px; position: relative; width: 486px; will-change: var(--framer-will-change-override, transform); }", ".framer-B5kiH .framer-1elania { flex: none; height: auto; position: relative; white-space: pre; width: auto; }", ".framer-B5kiH .framer-1jajksr-container { cursor: pointer; flex: none; height: 100%; left: 20px; position: absolute; top: calc(50.00000000000002% - 100% / 2); width: 92%; z-index: 2; }", ".framer-B5kiH .framer-acwhom { flex: none; height: var(--framer-aspect-ratio-supported, 24px); position: relative; width: 24px; }"];
var FramergodgLM0uU = withCSS3(Component2, css2, "framer-B5kiH");
var stdin_default3 = FramergodgLM0uU;
FramergodgLM0uU.displayName = "Search Bar";
FramergodgLM0uU.defaultProps = { height: 50, width: 486 };
addFonts(FramergodgLM0uU, [{ explicitInter: true, fonts: [{ family: "Inter", source: "framer", style: "normal", unicodeRange: "U+0460-052F, U+1C80-1C88, U+20B4, U+2DE0-2DFF, U+A640-A69F, U+FE2E-FE2F", url: "https://framerusercontent.com/assets/5vvr9Vy74if2I6bQbJvbw7SY1pQ.woff2", weight: "400" }, { family: "Inter", source: "framer", style: "normal", unicodeRange: "U+0301, U+0400-045F, U+0490-0491, U+04B0-04B1, U+2116", url: "https://framerusercontent.com/assets/EOr0mi4hNtlgWNn9if640EZzXCo.woff2", weight: "400" }, { family: "Inter", source: "framer", style: "normal", unicodeRange: "U+1F00-1FFF", url: "https://framerusercontent.com/assets/Y9k9QrlZAqio88Klkmbd8VoMQc.woff2", weight: "400" }, { family: "Inter", source: "framer", style: "normal", unicodeRange: "U+0370-03FF", url: "https://framerusercontent.com/assets/OYrD2tBIBPvoJXiIHnLoOXnY9M.woff2", weight: "400" }, { family: "Inter", source: "framer", style: "normal", unicodeRange: "U+0100-024F, U+0259, U+1E00-1EFF, U+2020, U+20A0-20AB, U+20AD-20CF, U+2113, U+2C60-2C7F, U+A720-A7FF", url: "https://framerusercontent.com/assets/JeYwfuaPfZHQhEG8U5gtPDZ7WQ.woff2", weight: "400" }, { family: "Inter", source: "framer", style: "normal", unicodeRange: "U+0000-00FF, U+0131, U+0152-0153, U+02BB-02BC, U+02C6, U+02DA, U+02DC, U+2000-206F, U+2074, U+20AC, U+2122, U+2191, U+2193, U+2212, U+2215, U+FEFF, U+FFFD", url: "https://framerusercontent.com/assets/vQyevYAyHtARFwPqUzQGpnDs.woff2", weight: "400" }, { family: "Inter", source: "framer", style: "normal", unicodeRange: "U+0102-0103, U+0110-0111, U+0128-0129, U+0168-0169, U+01A0-01A1, U+01AF-01B0, U+1EA0-1EF9, U+20AB", url: "https://framerusercontent.com/assets/b6Y37FthZeALduNqHicBT6FutY.woff2", weight: "400" }] }, ...SearchFonts, ...Search1Fonts], { supportsExplicitInterCodegen: true });
